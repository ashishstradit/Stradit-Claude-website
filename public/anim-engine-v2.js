/* ============================================================
   STRADIT — Hero Animation Engine
   WebGL-feeling canvas particles with themed presets per page.
   No deps, no React. Drop a <canvas data-hero-anim="theme"> and call init.
   ============================================================ */
...
(function () {
  ...
  const THEMES = {
    ...
    // StartIT — particle vortex, accelerating + bursting
    startit: {
      kind: "vortex",
      bg: "#060912",
      colorA: [255, 122, 61],
  ...
  // 8) Vortex — particles spiraling toward center
  ...
  // ---------------------------------------------------------
  function init() {
    document.querySelectorAll("canvas[data-hero-anim]").forEach(canvas => {
  ...
  // Expose for Next.js SPA navigation
  window.__straditAnimSingle = function(canvas) {
    ...
    switch (theme.kind) {
      ...
      case 'orbits': orbits(canvas, theme); break;
      case 'dataflow': dataflow(canvas, theme); break;
      case 'shieldGrid': shieldGrid && shieldGrid(canvas, theme); break;
      case 'lockMatrix': lockMatrix(canvas, theme); break;
      case 'field': field(canvas, theme); break;
      case 'dag': dag(canvas, theme); break;
      case 'globe': globe(canvas, theme); break;
